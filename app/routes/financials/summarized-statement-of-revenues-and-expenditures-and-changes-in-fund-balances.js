...
export default Route.extend(GoogleAnalyticsMixin, ResetScrollMixin, {
  ...
  afterModel() {
    ...
    set(this, 'headData.url', `${ENV.host}${ENV.rootURL}financials/summarized-statement-of-revenues-and-expenditures-and-changes-in-fund-balances/`);
    set(this, 'headData.image', this.backgroundImage.defaultBackground.ogUrl);

    // Load next route background
    const nextRoute = this.routeOrder.getNextRoute('financials.rsummarized-statement-of-revenues-and-expenditures-and-changes-in-fund-balances');
    if (nextRoute) {
