...
export default Service.extend({
  ...
  routes: computed('intl.locale', function() {
    ...
    return [{
      ...
      number: '10',
      route: isFrenchLocale ? 'fr.slide-8' : 'en.slide-8',
      subRoutes: [],
      title: 'slide8.title',
    }, {
      number: '11',
      route: isFrenchLocale ? 'fr.slide-9' : 'en.slide-9',
      subRoutes: [],
      title: 'slide9.title',
    }, {
      number: '12',
      route: isFrenchLocale ? 'fr.slide-10' : 'en.slide-10',
      subRoutes: [],
      title: 'slide10.title',
    }, {
      number: '13',
      route: isFrenchLocale ? 'fr.slide-11' : 'en.slide-11',
      subRoutes: [],
      title: 'slide11.title',
    }, {
      number: '14',
      route: isFrenchLocale ? 'fr.slide-12' : 'en.slide-12',
      subRoutes: [],
      title: 'slide12.title',
    }, {
      number: '15',
      route: isFrenchLocale ? 'fr.slide-13' : 'en.slide-13',
      subRoutes: [],
      title: 'slide13.title',
    }, {
      number: '16',
