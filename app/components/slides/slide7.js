...
export default class SlidesSlide7Component extends Component {
  @service backgroundImage;
  @service intl;

  get backgroundStyle() {
    const { fullSizeUrl, thumbnailUrl } = this.backgroundImage.getSlideBackgroundImage('en.slide-7');
  ...
  get photoCredit() {
    return this.intl.t('slide7.photoCredit');
  }
