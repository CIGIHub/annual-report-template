...
export default class SlidesSlide12Component extends Component {
  @service backgroundImage;
  @service intl;

  get backgroundStyle() {
    const { fullSizeUrl, thumbnailUrl } = this.backgroundImage.getSlideBackgroundImage('en.slide-12');
  ...
  get photoCredit() {
    return this.intl.t('slide12.photoCredit');
  }
  ...
  get videoLink() {
    return `${this.backgroundImage.imageHost}template/slides/slide-12.mp4`;
  }
}
