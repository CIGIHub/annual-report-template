...
module('Acceptance | fr/slide 2', function(hooks) {
  ...
  test('should have correct meta', async function(assert) {
    ...
    assert.strictEqual(
      ...
      'https://www.cigionline.org/interactives/annualreporttemplate/fr/slide2-fr',
    );
    assert.strictEqual(
  ...
  test('should have correct social links', async function(assert) {
    ...
    assert.dom('.social-2-btn').hasAttribute('href', 'https://twitter.com/intent/tweet?status=Rapport+annuel+2019+https://www.cigionline.org/interactives/annualreporttemplate/fr/slide2-fr');
    assert.dom('.social-3-btn').hasAttribute('href', 'https://www.linkedin.com/shareArticle?mini=true&url=https://www.cigionline.org/interactives/annualreporttemplate/fr/slide2-fr');
  });
  ...
  test('should have correct slide content', async function(assert) {
    ...
    assert.dom('.footer .footer-description').containsText('Slide 2 Photo Credit French');
  });
  ...
  test('should transition to /en/slide2-en on intl-link click', async function(assert) {
    await visit('/fr/slide2-fr');
