...
module('Acceptance | fr/slide 13', function(hooks) {
  ...
  test('should have correct meta', async function(assert) {
    ...
    assert.strictEqual(
      ...
      'https://www.cigionline.org/interactives/annualreporttemplate/fr/slide13-fr',
    );
    assert.strictEqual(
  ...
  test('should have correct social links', async function(assert) {
    ...
    assert.dom('.social-2-btn').hasAttribute('href', 'https://twitter.com/intent/tweet?status=Rapport+annuel+2019+https://www.cigionline.org/interactives/annualreporttemplate/fr/slide13-fr');
    assert.dom('.social-3-btn').hasAttribute('href', 'https://www.linkedin.com/shareArticle?mini=true&url=https://www.cigionline.org/interactives/annualreporttemplate/fr/slide13-fr');
  });
  ...
  test('should have correct slide content', async function(assert) {
    ...
    assert.dom('.footer .footer-description').containsText('Slide 13 Photo Credit French');
  });
