...
module('Acceptance | en/slide 4', function(hooks) {
  ...
  test('should have correct meta', async function(assert) {
    ...
    assert.strictEqual(
      ...
      'https://www.cigionline.org/interactives/annualreporttemplate/en/slide4-en',
    );
    assert.strictEqual(
  ...
  test('should have correct social links', async function(assert) {
    ...
    assert.dom('.social-2-btn').hasAttribute('href', 'https://twitter.com/intent/tweet?status=2019+CIGI+Annual+Report+https://www.cigionline.org/interactives/annualreporttemplate/en/slide4-en');
    assert.dom('.social-3-btn').hasAttribute('href', 'https://www.linkedin.com/shareArticle?mini=true&url=https://www.cigionline.org/interactives/annualreporttemplate/en/slide4-en');
  });
  ...
  test('should have correct slide content', async function(assert) {
    ...
    assert.dom('.slide-content .content-links a:nth-of-type(1) .content-copy p').containsText('Slide 4 Link 1 English');
    assert.dom('.slide-content .content-links a:nth-of-type(2) .content-copy h4').containsText('Paper Series');
    assert.dom('.slide-content .content-links a:nth-of-type(2) .content-copy p').containsText('Slide 4 Link 2 English');
    assert.dom('.slide-content .content-links a:nth-of-type(3) .content-copy h4').containsText('Article');
    assert.dom('.slide-content .content-links a:nth-of-type(3) .content-copy p').containsText('Slide 4 Link 3 English');
    assert.dom('.slide-content .content-links-mobile').exists();
    assert.dom('.slide-content .content-links-mobile a').exists({ count: 3 });
    assert.dom('.slide-content .content-links-mobile a:nth-of-type(1)').containsText('Slide 4 Link 1 English');
    assert.dom('.slide-content .content-links-mobile a:nth-of-type(2)').containsText('Slide 4 Link 2 English');
    assert.dom('.slide-content .content-links-mobile a:nth-of-type(3)').containsText('Slide 4 Link 3 English');
    assert.dom('.slide-content .paragraphs').exists();
    assert.dom('.slide-content .paragraphs p').exists({ count: 3 });
    assert.dom('.slide-content .paragraphs p:nth-of-type(1)').containsText('Slide 4 Paragraph 1 English');
    assert.dom('.slide-content .paragraphs p:nth-of-type(2)').containsText('Slide 4 Paragraph 2 English');
    assert.dom('.slide-content .paragraphs p:nth-of-type(3)').containsText('Slide 4 Paragraph 3 English');
    ...
    assert.dom('.background-image .hover-reveal .quote h3.hover-reveal-quote').containsText('Slide 4 Quote English');
    assert.dom('.background-image .hover-reveal .quote h4.hover-reveal-quote-source').containsText('Slide 4 Source English');
    ...
    assert.dom('.footer .footer-description').containsText('Slide 4 Photo Credit English');
  });
  ...
  test('should transition to /en/slide5-en on scroll-arrow-down-btn click', async function(assert) {
    await visit('/en/slide4-en');
  ...
  test('should transition to /fr/slide4-fr on intl-link click', async function(assert) {
    await visit('/en/slide4-en');
