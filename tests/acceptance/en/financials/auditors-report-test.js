...
module('Acceptance | en/financials/auditors report', function(hooks) {
  setupApplicationTest(hooks);

  test('visiting /en/financials/auditors-report', async function(assert) {
  ...
  test('should have correct meta', async function(assert) {
    ...
    assert.strictEqual(
      ...
      'https://www.cigionline.org/interactives/annualreporttemplate/en/financials/auditors-report',
    );
    assert.strictEqual(
  ...
  test('should have correct social links', async function(assert) {
    ...
    assert.dom('.social-2-btn').hasAttribute('href', 'https://twitter.com/intent/tweet?status=2019+CIGI+Annual+Report+https://www.cigionline.org/interactives/annualreporttemplate/en/financials/auditors-report');
    assert.dom('.social-3-btn').hasAttribute('href', 'https://www.linkedin.com/shareArticle?mini=true&url=https://www.cigionline.org/interactives/annualreporttemplate/en/financials/auditors-report');
  });
  ...
  test('should have correct slide content', async function(assert) {
    ...
    assert.dom('.financials .financials-menu > a:nth-of-type(1)').containsText('Summarized Statement of Financial Position');
