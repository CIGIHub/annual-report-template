...
module('Acceptance | en/financials/summarized statement of revenues and expenditures and changes in fund balances', function(hooks) {
  ...
  test('should have correct meta', async function(assert) {
    ...
    assert.strictEqual(
      ...
      'https://www.cigionline.org/interactives/annualreporttemplate/en/financials/summarized-statement-of-revenues-and-expenditures-and-changes-in-fund-balances',
    );
    assert.strictEqual(
  ...
  test('should have correct social links', async function(assert) {
    ...
    assert.dom('.social-2-btn').hasAttribute('href', 'https://twitter.com/intent/tweet?status=2019+CIGI+Annual+Report+https://www.cigionline.org/interactives/annualreporttemplate/en/financials/summarized-statement-of-revenues-and-expenditures-and-changes-in-fund-balances');
    assert.dom('.social-3-btn').hasAttribute('href', 'https://www.linkedin.com/shareArticle?mini=true&url=https://www.cigionline.org/interactives/annualreporttemplate/en/financials/summarized-statement-of-revenues-and-expenditures-and-changes-in-fund-balances');
  });
  ...
  test('should have correct slide content', async function(assert) {
    ...
    assert.dom('.financials .financials-menu').containsText('Summarized Statement of Revenues and Expenditures and Changes in Fund Balances');
    ...
    assert.dom('.financials .financials-content .table-title td:nth-of-type(1)').containsText('Summarized Statement of Revenues and Expenditures and Changes in Fund Balances for the year ended July 31, 2019');
