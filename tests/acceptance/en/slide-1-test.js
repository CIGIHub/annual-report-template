...
module('Acceptance | en/slide 1', function(hooks) {
  setupApplicationTest(hooks);

  test('visiting /en/slide1-en', async function(assert) {
    await visit('/en/slide1-en');
  ...
  test('should have correct meta', async function(assert) {
    ...
    assert.strictEqual(
      ...
      'https://www.cigionline.org/interactives/annualreporttemplate/en/slide1-en',
    );
    assert.strictEqual(
  ...
  test('should have correct social links', async function(assert) {
    ...
    assert.dom('.social-2-btn').hasAttribute('href', 'https://twitter.com/intent/tweet?status=2019+CIGI+Annual+Report+https://www.cigionline.org/interactives/annualreporttemplate/en/slide1-en');
    assert.dom('.social-3-btn').hasAttribute('href', 'https://www.linkedin.com/shareArticle?mini=true&url=https://www.cigionline.org/interactives/annualreporttemplate/en/slide1-en');
  });
  ...
  test('should transition to /en/slide2-en on scroll-arrow-down-btn click', async function(assert) {
    await visit('/en/slide1-en');
  ...
  test('should transition to /fr/slide1-fr on intl-link click', async function(assert) {
    await visit('/en/slide1-en');
