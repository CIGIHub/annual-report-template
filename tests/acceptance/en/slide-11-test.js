...
module('Acceptance | en/slide 11', function(hooks) {
  ...
  test('should have correct meta', async function(assert) {
    ...
    assert.strictEqual(
      ...
      'https://www.cigionline.org/interactives/annualreporttemplate/en/slide11-en',
    );
    assert.strictEqual(
    ...
    assert.strictEqual(
      ...
      'https://staging.cigionline.org/interactives/annualreporttemplate/static/template/slides/slide-11-og.jpg',
    );
    assert.strictEqual(
  ...
  test('should have correct social links', async function(assert) {
    ...
    assert.dom('.social-2-btn').hasAttribute('href', 'https://twitter.com/intent/tweet?status=2019+CIGI+Annual+Report+https://www.cigionline.org/interactives/annualreporttemplate/en/slide11-en');
    assert.dom('.social-3-btn').hasAttribute('href', 'https://www.linkedin.com/shareArticle?mini=true&url=https://www.cigionline.org/interactives/annualreporttemplate/en/slide11-en');
  });
  ...
  test('should have correct slide content', async function(assert) {
    ...
    assert.dom('.background-image').hasAttribute('style', "background-image: url('https://staging.cigionline.org/interactives/annualreporttemplate/static/template/slides/slide-11.jpg'), url('https://staging.cigionline.org/interactives/annualreporttemplate/static/template/slides/slide-11-thumbnail.jpg');");
    ...
    assert.dom('.footer .footer-description').containsText('Slide 11 Photo Credit English');
  });
  ...
  test('should transition to /en/slide12-en on scroll-arrow-down-btn click', async function(assert) {
    await visit('/en/slide11-en');
