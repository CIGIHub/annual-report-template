...
module('Acceptance | financials/revenue and expenses', function(hooks) {
  ...
  test('should have correct twitter share link', async function(assert) {
    ...
    assert.dom('.social-2-btn').hasAttribute('href', 'https://twitter.com/intent/tweet?status=2019+CIGI+Annual+Report+https://www.cigionline.org/interactives/2019annualreport/financials/revenue-and-expenses');
  });

  test('should have correct linkedin share link', async function(assert) {
    await visit('/financials/revenue-and-expenses');

    assert.dom('.social-3-btn').hasAttribute('href', 'https://www.linkedin.com/shareArticle?mini=true&url=https://www.cigionline.org/interactives/2019annualreport/financials/revenue-and-expenses');
  });
